...
import pertemuan12.DeleteDatasiswa;
import pertemuan12.InsertDatasiswa;
import pertemuan12.Kelas;
import pertemuan12.UpdateDatasiswa;
        ...
        try {
            ...
            for (Datasiswa p : datalist) {
                model.addRow(new Object[]{
                    ...
                    p.getWaliKelas(),
                    p.getWaliMurid(),
                    p.getIdKelas() != null ? p.getIdKelas().getIdKelas() : "" // Cek null untuk idKelas
                });
            }
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (data.length == 5) {
                        try {
                            ...
                            if (kelas == null) {
                                System.out.println("⚠ Kelas tidak ditemukan untuk ID: " + idkelas);
                                continue;
                            }
